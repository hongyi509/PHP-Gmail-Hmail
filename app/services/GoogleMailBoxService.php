...
class GoogleMailBoxService {
  ...
  const SEND_BASE_URL = "https://www.googleapis.com/upload/gmail/v1/users/me/messages/send?uploadType=media";
  ...
  public function get_mails() {
    $url = self::MAIL_BASE_URL.'shlerp11@gmail.com/messages/1';
    echo($url);
